...
CREATE TABLE IF NOT EXISTS activity_feed (id TEXT PRIMARY KEY, module TEXT, action TEXT, record_no TEXT, user_id TEXT, user_name TEXT, detail TEXT, status TEXT DEFAULT 'active', created_at TEXT DEFAULT CURRENT_TIMESTAMP, updated_at TEXT, created_by TEXT, updated_by TEXT);
